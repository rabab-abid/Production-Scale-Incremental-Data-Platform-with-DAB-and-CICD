# deployment_asset_bundles

The 'deployment_asset_bundles' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/deployment_asset_bundles/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] deployment_asset_bundles_etl` to your workspace.
